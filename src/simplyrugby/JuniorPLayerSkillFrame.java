 ...
 * @author HP
 */
public class JuniorPLayerSkillFrame extends javax.swing.JFrame {
    ...
    JuniorPlayerSkillDAO playerSkillDAO = new JuniorPlayerSkillDAOImpl();

    public JuniorPLayerSkillFrame() {
        initComponents();
        fillAllCombos();
        fillTable();
        setLocation(350, 50);
    ...
    public void setFields(JuniorPlayerSkill playerSkill) {
    ...
    public void fillAllCombos() {
        ...
        List<JuniorPlayer> players = playerDAO.getAllPlayersByTeamId(team.getTeamId());
        for (JuniorPlayer player : players) {
    ...
    public void fillTable() {
        ...
        List<JuniorPlayerSkill> playerSkills = playerSkillDAO.getAllPlayerSkills();

        for (JuniorPlayerSkill p : playerSkills) {
    ...
    private void addSkillBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addSkillBtnActionPerformed
        JuniorPlayerSkill playerSkill = getPlayerSkill();
    ...
    private void playerSkillTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_playerSkillTableMouseClicked
        ...
        JuniorPlayerSkill existingPlayerSkill = playerSkillDAO.getPlayerSkillById(playerSkillId);
